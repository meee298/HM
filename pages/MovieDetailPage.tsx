...
import { Star, Share2, Plus, Flag, Play, ThumbsUp, Loader2, Calendar, Clock, Film } from 'lucide-react';
  ...
  if (!movie) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#0a0a0a] text-white p-6">
        <div className="text-center max-w-md space-y-8 animate-fadeIn">
    ...
    <div className="min-h-screen bg-[#050505] text-white selection:bg-red-600 overflow-x-hidden pb-20">
      ...
      <div className="relative w-full min-h-[80vh] md:min-h-[90vh] flex items-center pb-64 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img src={movie.backdropUrl} className="w-full h-full object-cover scale-105" alt="backdrop" />
        ...
        <div className="relative z-10 w-full max-w-[1600px] mx-auto px-8 sm:px-16 pt-32">
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            <div className="hidden lg:block w-80 rounded-[2.5rem] overflow-hidden shadow-[0_30px_60px_rgba(0,0,0,0.8)] border border-white/10 shrink-0 transform hover:scale-[1.02] transition-transform duration-500">
      ...
      <div ref={playerRef} className="relative z-20 -mt-40 md:-mt-56 pb-20 px-6 max-w-[1500px] mx-auto">
      ...
      <div className="max-w-[1500px] mx-auto px-6 mt-20">
         <div className="flex items-center gap-4 mb-10">
           ...
           <h3 className="text-3xl font-black">قد يعجبك أيضاً</h3>
         </div>
         {/* Here we could inject similar movies carousel if available */}
         <div className="bg-white/5 p-20 rounded-[3rem] border border-white/5 text-center flex flex-col items-center gap-6">
            ...
            <p className="text-gray-500 font-bold">جاري تحميل الاقتراحات المخصصة لك...</p>
         </div>
      </div>
    </div>
  );
