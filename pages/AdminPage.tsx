...
const AdminPage: React.FC = () => {
  ...
  // --- Seeding Logic for Top and Timeless Content ---
  const seedTimelessContent = async () => {
    if (!window.confirm('هل تريد استيراد مجموعة من أفضل الأفلام والمسلسلات الخالدة إلى قاعدة بياناتك؟')) return;
    
    setIsProcessing(true);
    const timelessData: Partial<Movie>[] = [
      {
        id: 'the_godfather_1972',
        title: 'The Godfather (العراب)',
        description: 'الملحمة السينمائية التي تتناول قصة عائلة كوريليوني الإجرامية في نيويورك، وصعود مايكل كوريليوني ليكون القطب الجديد للعائلة.',
        type: 'movie',
        genre: ['دراما', 'جريمة'],
        year: 1972,
        duration: '175 دقيقة',
        rating: '18+',
        quality: 'FHD',
        thumbnailUrl: 'https://image.tmdb.org/t/p/original/3bhkrjSTWv4mG0oY1I4DzDYS0ST.jpg',
        backdropUrl: 'https://image.tmdb.org/t/p/original/tmU7GeKVZ2pSdhZvyky9Df9vXU9.jpg',
        tmdbId: '238',
        embedCode: '<iframe src="https://www.vidking.net/embed/movie/238" width="100%" height="100%" frameborder="0" allowfullscreen></iframe>',
        isFeatured: true,
        isTrending: true
      },
      {
        id: 'inception_2010',
        title: 'Inception (بداية)',
        description: 'لص يسرق أسرار الشركات من خلال استخدام تكنولوجيا مشاركة الأحلام، يُعطى مهمة عكسية وهي زرع فكرة في عقل أحد الرؤساء التنفيذيين.',
        type: 'movie',
        ...
        rating: '13+',
        quality: '4K',
        thumbnailUrl: 'https://image.tmdb.org/t/p/original/o0Iji699Xv9YvY6O680DURm8v0F.jpg',
        backdropUrl: 'https://image.tmdb.org/t/p/original/8Z99vLT0f8Z8X8SFr99uM9clVvW.jpg',
        tmdbId: '27205',
        embedCode: '<iframe src="https://www.vidking.net/embed/movie/27205" width="100%" height="100%" frameborder="0" allowfullscreen></iframe>',
        isFeatured: false,
        isTrending: true
      },
      {
        id: 'breaking_bad_series',
        title: 'Breaking Bad (اختلال ضال)',
        description: 'مدرس كيمياء في المدرسة الثانوية يتم تشخيصه بسرطان الرئة غير القابل للعلاج، فيتحول إلى تصنيع الميثامفيتامين لتأمين مستقبل عائلته المالي.',
        type: 'series',
        genre: ['دراما', 'جريمة', 'غموض'],
        year: 2008,
        duration: '5 مواسم',
        rating: '18+',
        quality: 'FHD',
        thumbnailUrl: 'https://image.tmdb.org/t/p/original/ztkUQvBZ6pDAt68pXvU9i9p968T.jpg',
        backdropUrl: 'https://image.tmdb.org/t/p/original/9fa9pUMc792R6M0C1na8pY9R86V.jpg',
        tmdbId: '1396',
        totalSeasons: 5,
        totalEpisodes: 62,
        isFeatured: true,
        ...
        episodes: [
            {
                ...
                number: 1,
                title: 'الحلقة الأولى',
                embedCode: '<iframe src="https://www.vidking.net/embed/tv/1396/1/1" width="100%" height="100%" frameborder="0" allowfullscreen></iframe>'
            }
        ]
      },
      {
        id: 'interstellar_2014',
        title: 'Interstellar (بين النجوم)',
        description: 'فريق من المستكشفين يسافرون عبر ثقب دودي في الفضاء في محاولة لضمان بقاء البشرية، بينما تواجه الأرض كارثة بيئية.',
        type: 'movie',
        ...
        rating: 'All',
        quality: '4K',
        thumbnailUrl: 'https://image.tmdb.org/t/p/original/gEU2QniE6EJBQwOQv2sqIduz1S.jpg',
        backdropUrl: 'https://image.tmdb.org/t/p/original/xJHbt7uJs97u589An9S8Xm6YQCX.jpg',
        tmdbId: '157336',
        embedCode: '<iframe src="https://www.vidking.net/embed/movie/157336" width="100%" height="100%" frameborder="0" allowfullscreen></iframe>',
        isFeatured: true,
        isTrending: false
      }
    ];
    ...
    try {
      for (const item of timelessData) {
        await MovieService.save(item as Movie);
      }
      setMessage({ type: 'success', text: 'تم استيراد الكلاسيكيات بنجاح!' });
      await fetchContent();
    } catch (err) {
            ...
            <div className="bg-[#111] rounded-[2rem] p-6 border border-white/5 sticky top-28 shadow-2xl space-y-8">
              ...
              <div className="pt-8 border-t border-white/5 space-y-3">
                <div className="px-4 mb-2">
                  <span className="text-[10px] font-black text-gray-600 uppercase tracking-widest">إضافات سريعة</span>
                </div>
                <button 
                   onClick={seedTimelessContent}
                   className="w-full text-right px-6 py-4 rounded-2xl flex items-center gap-4 bg-yellow-600/10 text-yellow-500 hover:bg-yellow-600 hover:text-white border border-yellow-600/20 transition-all font-bold"
                >
                  <Trophy className="w-5 h-5" /> استيراد كلاسيكيات
                </button>
              </div>
                            ...
                            <tr key={item.id} className="hover:bg-white/[0.02] transition-colors group">
                              ...
                              <td className="p-8 text-center">
                                <div className="flex items-center justify-center gap-3">
                                  {item.rating === '18+' && <ShieldAlert className="w-5 h-5 text-red-500" title="18+" />}
                                  {item.isFeatured && <div className="w-3 h-3 rounded-full bg-red-600 shadow-[0_0_10px_rgba(229,9,20,0.8)]" title="مميز" />}
                                  {item.isTrending && <Flame className="w-5 h-5 text-orange-500 fill-current" title="رائج" />}
                                </div>
                              </td>
                              <td className="p-8">
